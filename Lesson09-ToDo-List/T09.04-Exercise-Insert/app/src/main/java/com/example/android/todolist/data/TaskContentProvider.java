...
public class TaskContentProvider extends ContentProvider {
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        // comleted (1) Get access to the task database (to write new data to)
        SQLiteDatabase sqlDB = mTaskDbHelper.getWritableDatabase();
        ...
        switch(uriType) {
            ...
            case TASKS:
                long id = sqlDB.insert(TaskContract.TaskEntry.TABLE_NAME, null, values);
                if (id > 0){
                    //success
