    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // compelted (1) Retrieve the text from the EditText and store it in a variable
                String mText = mNameEntry.toString();
                ...
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, mText);
