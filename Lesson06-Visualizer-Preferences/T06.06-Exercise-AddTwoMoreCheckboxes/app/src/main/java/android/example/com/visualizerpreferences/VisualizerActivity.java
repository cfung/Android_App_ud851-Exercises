...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // compelted (4) Update the code in setupSharedPreferences and onSharedPreferenceChanged to update
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean("show_midrange",
