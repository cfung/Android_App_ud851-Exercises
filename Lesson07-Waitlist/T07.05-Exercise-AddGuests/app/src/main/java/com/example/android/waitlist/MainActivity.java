...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText mNewGuestNameEditText = (EditText) findViewById(R.id.person_name_edit_text);
        EditText mNewPartySizeEditText = (EditText) findViewById(R.id.party_count_edit_text);
        ...
        // compelted (3) Remove this fake data call since we will be inserting our own data now
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            ...
            //e.printStackTrace();
            Log.e(LOG_TAG, "failed to parse party size text to num.." + e.getMessage());
        }
    ...
    private long addGuest(String guest, int partySize){

        ContentValues contentValues = new ContentValues();
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, guest);
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, partySize);
        long dbID = 0;

        try{
            mDb.beginTransaction();
            mDb.delete(WaitlistContract.WaitlistEntry.TABLE_NAME, null, null);
            dbID = mDb.insert(WaitlistContract.WaitlistEntry.TABLE_NAME, null, contentValues);
